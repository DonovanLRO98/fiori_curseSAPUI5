		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#devlogaliinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"devlogaliinvoices-display": {
								"semanticObject": "devlogaliinvoices",
								"action": "display",
								"description": "SAP Fiori APP Curse",
								"title": "Invoices List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=devlogali.invoices",
									"url": sap.ui.require.toUrl("devlogali/invoices")
								}
							}
						}
					}
